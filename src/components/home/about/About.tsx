...
function AboutCard({
  ...
  return (
    <motion.article
      variants={cardVariants(section.entrance, shouldReduceMotion)}
      initial={false}
    ...
    >
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-3 mb-3">
          <motion.span
            initial={false}
            animate={canAnimate ? undefined : { opacity: 1, scale: 1 }}
          ...
          <motion.h3
            initial={false}
            animate={canAnimate ? undefined : { opacity: 1, x: 0 }}
          ...
          >
            {section.list.map((item, itemIndex) => (
              ...
              >
                <motion.span
                  initial={false}
                  animate={canAnimate ? undefined : { scale: 1 }}
